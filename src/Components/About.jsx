...
export default function About() {
  ...
  return (
    <section id="About" className="relative bg-black min-h-screen flex flex-col md:flex-row justify-center items-center px-6 overflow-hidden border-b-2 border-white border-t-2">
  ...
  className="px-10 py-5 rounded-lg bg-yellow-400  text-black text-2xl font-semibold hover:bg-gray-400 hover:text-white transition border-2"
>
  Go to Projects ➜
</button>
        </div>
      ...
      <div className="flex flex-col justify-center items-center border-2 border-blue-500 rounded-xl p-6 m-6 w-full sm:w-3/4 md:w-1/2 lg:w-96 bg-black/50 backdrop-blur-md shadow-[0_0_20px_#3b82f6]">
       ...
       <p className="text-white text-lg leading-relaxed mb-3 border-l-[5px] border-blue-900 italic pl-5">
...
<p className="text-white text-sm leading-relaxed mb-3">
  I also work with Machine Learning models, building intelligent systems for data analysis, 
  prediction, and automation using Python and modern ML frameworks.
</p>

<p className="text-white text-sm leading-relaxed">
  <span className="font-semibold text-yellow-300">Full Stack & AI Projects:</span>
  From authentication systems with role-based access, to resource coordination platforms,
  portfolio websites, and machine learning-based predictive systems, 
  I enjoy solving real-world problems with clean code and scalable architecture.
</p>
      </div>
    </section>
  );
